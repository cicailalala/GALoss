...
from utils import metrics, ramps, test_util_vnet_AB, cube_losses, cube_utils
...
parser.add_argument('--root_path', type=str, default='./data/Synapse/', help='Name of Dataset')
...
if args.labelnum == 2:
    ...
    unlabeled_list = ['0001', '0002', '0003', '0005', '0008', '0009', '0021', '0022', '0024', '0027', '0029', '0030', '0031', '0032', '0034', '0037', '0038', '0039']
elif args.labelnum == 4:
    # 20%, 4 labeld 
    labeled_list = ['0002', '0023', '0034', '0039']
    unlabeled_list = ['0001', '0003', '0005', '0008', '0009', '0021', '0022', '0024', '0027', '0028', '0029', '0030', '0031', '0032', '0037', '0038']
else:
    print('Error labelnum!')
    os.exit()
eval_list = ['0006', '0025', '0026', '0040']
...
def train(labeled_list, unlabeled_list, eval_list, fold_id=1):
    ...
    for file_name in files:
        if ('log_fold' in file_name) or ('events.out' in file_name):
            print(os.path.join(snapshot_path, file_name))
            os.chmod(os.path.join(snapshot_path, file_name), stat.S_IRWXU+stat.S_IRWXG+stat.S_IRWXO)
    ...
    for epoch_num in iterator:
        ...
        for i_batch, sampled_batch in enumerate(trainloader):
            ...
            if iter_num % 500 == 0:
                model_A.eval()
                model_B.eval()
                dice_all, std_all, metric_all_cases = test_util_vnet_AB.validation_all_case_fast(model_A, model_B,
